...
besides PAM and nsswitch.conf and it strictly prohibits any manual changes to
...
NIS
~~~
There are several places that need to be configured in order to make
...
reboot your system. Additionally, it may be necessary to enable NIS in SELinux.
